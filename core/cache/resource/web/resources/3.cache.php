<?php  return array (
  ...
  array (
    ...
    'isfolder' => 1,
    'introtext' => '',
    'content' => ' <section class="section section-top section-top-page">
    <div class="container">
      <h1>Про нас</h1>
    </div>
  </section>
...
[[$partners]]',
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1560078674,
    'editedby' => 1,
    'editedon' => 1560970618,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1560970618,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<section class="section section-content section-ui" id="feedback">
  <div class="container">
    <div class="row">
      <div class="col-md-6 align-self-center">
...
<div id="preloader-wrapper">
  ...
  <header class="header" id="header">
    ...
    '[[$feedback]]' => '<section class="section section-content section-ui" id="feedback">
  <div class="container">
    <div class="row">
      <div class="col-md-6 align-self-center">
        <div class="title text-left">
  ...
  <form action="" class="form">
    ...
    '[[$partners]]' => ' <section class="section section-content section-light-gray">
  <div class="container">
    <div class="title">
      <h2 class="title__upper">Потужність і безпека з мережею партнерів</h2>
    </div>
    ...
    <div class="container">
      ...
      array (
        ...
        array (
          ...
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '<section class="section section-content section-ui" id="feedback">
  <div class="container">
    <div class="row">
      <div class="col-md-6 align-self-center">
        <div class="title text-left">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="section section-content section-ui" id="feedback">
  <div class="container">
    <div class="row">
      <div class="col-md-6 align-self-center">
        <div class="title text-left">
    ...
    <div class="container">
      ...
      array (
        ...
        array (
          ...
          'category' => 0,
          'cache_type' => 0,
          'snippet' => ' <section class="section section-content section-light-gray">
  <div class="container">
    <div class="title">
      <h2 class="title__upper">Потужність і безпека з мережею партнерів</h2>
    </div>
    <div class="slider partners-slider">
      ...
      <div><img src="/img/partners__5.png" alt=""></div>
          ...
          'static' => false,
          'static_file' => '',
          'content' => ' <section class="section section-content section-light-gray">
  <div class="container">
    <div class="title">
      <h2 class="title__upper">Потужність і безпека з мережею партнерів</h2>
    </div>
